...
class ClefMeasures(notes: ArrayList<MidiNote>,
    ...
    fun GetClef(starttime: Int): Clef { /* If the time exceeds the last measure, return the last measure */
    ...
    init {
        ...
        var clef = mainclef
        clefs = ArrayList()
        while (pos < notes.size) { /* Sum all the notes in the current measure */
            var sumnotes = 0
            var notecount = 0
            ...
            if (avgnote == 0) { /* This measure doesn't contain any notes.
                ...
                clef = Clef.Bass
            } else { /* The average note is between G3 and F4. We can use either
