...
class TimeSigSymbol(
        ...
        /** The numerator  */
        private val denominator: Int) : MusicSymbol {
    /** True if we can draw the time signature  */
    private var candraw = numerator >= 0 && numerator < images!!.size && images!![numerator] != null && denominator >= 0 && denominator < images!!.size && images!![numerator] != null
    ...
    override fun Draw(canvas: Canvas, paint: Paint?, ytop: Int) {
        ...
        val imgheight: Int = SheetMusic.NoteHeight * 2
