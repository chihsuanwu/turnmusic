...
class WhiteNote(letter: Int, octave: Int) : Comparator<WhiteNote> {
    /* Get the letter */ val letter /* The letter of the note, A thru G */: Int
    /* Get the octave */ val octave /* The octave, 0 thru 10. */: Int
    ...
    val number: Int
        get() {
            ...
            return offset.toMidiNoteNumber(octave)
        }
