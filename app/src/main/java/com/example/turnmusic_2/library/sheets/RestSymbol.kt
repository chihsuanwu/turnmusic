...
class RestSymbol(
        ...
        private val duration: NoteDuration) : MusicSymbol {
     ...
     */
    override fun Draw(canvas: Canvas, paint: Paint?, ytop: Int) { /* Align the rest symbol to the right */
